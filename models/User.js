...
const userSchema = new mongoose.Schema({
    ...
    // --- NOUVEAU SYSTÈME LONG TERME (Choix parmi 4 produits) ---
    hasLongTerm: { type: Boolean, default: false },
    longTermProduct: { 
        type: { type: String },       // ex: 'lt_2000', 'lt_5000', etc.
        amount: { type: Number },     // Capital investi
        dailyGain: { type: Number },  // Gain journalier spécifique
        startDate: { type: Date },
